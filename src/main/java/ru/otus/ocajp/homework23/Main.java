package ru.otus.ocajp.homework23;

import java.util.Arrays;

// ДЗ: Создание методов, которые принимают аргументы и возвращают значения. Применение модификаторов доступ
public class Main {
    public static void main(String args[]) {
        System.out.println("Homework#23.\nJDK: " + System.getProperty("java.version"));
        print("9", "8", "7"); // print "9"
